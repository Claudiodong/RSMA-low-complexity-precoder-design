...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [A_p_k,a_p_k,phi_p_k]=SDMA_SAF_terms(H,G_MMSE_p_k,U_p_k,sigma)

          % find the parameter
          [Nt,~] = size(H);
          [Nr,N_common,Num_U] = size(G_MMSE_p_k);
          N_private = N_common;
          % define the variable
          ...
          % compute the terms with only private parts since SDMA is turned
          % off the common part in RSMA
          for i = 1:Num_U
            B = i*2-1:2*i;
