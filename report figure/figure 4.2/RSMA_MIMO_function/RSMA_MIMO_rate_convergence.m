...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [R_sum]=RSMA_MIMO_rate_convergence(H,Nr,SNR,sigma,weight,tolerance,max_count,H_power)
        ...
        Pri_precoder = sqrt(a_k/Num_U_Nr) .* (H./vecnorm(H)); % private precoder design
