...
grid on;
legend("RSMA low complexity $Q_{c}=1$",'RSMA low complexity $Q_{c}=2$','RSMA low complexity $Q_{c}=3$','RSMA low complexity $Q_{c}=4$','RSMA Adaptive $Q_{c}$');
xlabel("SNR [dB]");ylabel("Sum rate [bps/Hz]")
%% relative error
...
figure()
plot(SNR_dB,error1*100,'--x','LineWidth',1,'MarkerSize',8);
hold on;
plot(SNR_dB,error2*100,'--o','LineWidth',1,'MarkerSize',8);
hold on;
plot(SNR_dB,error3*100,'--v','LineWidth',1,'MarkerSize',8);
hold on;
plot(SNR_dB,error4*100,'--diamond','LineWidth',1,'MarkerSize',8);
hold on;
legend("RSMA low complexity $Q_{c}=1$",'RSMA low complexity $Q_{c}=2$','RSMA low complexity $Q_{c}=3$','RSMA low complexity $Q_{c}=4$');
grid on;
