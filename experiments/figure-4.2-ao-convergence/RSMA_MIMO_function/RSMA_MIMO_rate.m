...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [R1,R2,Common_precoder,Pri_precoder]=RSMA_MIMO_rate(H,Nr,alpha,SNR,sigma,weight,tolerance,max_count,Common_precoder,Pri_precoder)
        ...
        if (Common_precoder == 0)
            % initilised the precoder (MRT-SVD)
            Pri_precoder = sqrt(alpha*SNR/Num_U_Nr) .* (H./vecnorm(H)); % private precoder design
