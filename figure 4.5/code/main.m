...
for i_snr = 1:length(SNR)
     ...
     for i_max = 1:Max
        ...
        [t1] = netwon_raphson_method2(H,P_k,Num_U,tolerance,SNR(i_snr),1);
        [t2]=netwon_raphson_method2(H,P_k,Num_U,tolerance,SNR(i_snr),2);
        ...
        %  one stream
        [R_1_stream(i_max,i_snr),~,~]=adaptive_common_stream(H,1,Nr,P_k,SNR(i_snr),t1,Rnn,Num_U);

        % two streams
        [R_2_stream(i_max,i_snr),Pri_precoder,Com_precoder]=adaptive_common_stream(H,2,Nr,P_k,SNR(i_snr),t2,Rnn,Num_U);
